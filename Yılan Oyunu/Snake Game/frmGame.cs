...
namespace Snake_Game
{
    public partial class frmGame : Form
    {
        ...
        private void SnakeCrashControl() 
        {
            for (int i = 0; i < SnakePart.Length; i++) 
            {
                float mutlakX = Math.Abs((SnakePart[HeadIndex].Left + (SnakePart[HeadIndex].Width / 2))
                    - (SnakePart[i].Left + (SnakePart[i].Width / 2)));
                float mutlakY = Math.Abs((SnakePart[HeadIndex].Top + (SnakePart[HeadIndex].Height / 2))
                    - (SnakePart[i].Top + (SnakePart[i].Height / 2)));
        ...
        {
            float mutlakX = Math.Abs((SnakePart[HeadIndex].Left + (SnakePart[HeadIndex].Width / 2))
                - (Food.Left + (Food.Width / 2)));
            float mutlakY = Math.Abs((SnakePart[HeadIndex].Top + (SnakePart[HeadIndex].Height / 2)) 
                - (Food.Top + (Food.Height / 2)));
